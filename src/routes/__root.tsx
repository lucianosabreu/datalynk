...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "-ROfgArEfmLrMvhca2-CE858fCoJQQwMG8kv4h0x3MU" },
    ],
    links: [
    ...
    scripts: [
      {
        src: "https://www.googletagmanager.com/gtag/js?id=AW-1019185906",
        async: true,
      },
      {
        children:
          "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'AW-1019185906');",
      },
      {
